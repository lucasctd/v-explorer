...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    mutations: {
        setCurrentFolder: function setCurrentFolder(state, currentFolder) {
            state.currentFolder = currentFolder;
        },
        addSelectedFile: function addSelectedFile(state, file) {
            state.selectedFiles.push(file);
        },
        clearSelectedFiles: function clearSelectedFiles(state) {
            state.selectedFiles = [];
        },
        addItemToPath: function addItemToPath(state, item) {
            state.path.push(item);
        },
        openFolder: function openFolder(state, item) {
            this.commit('addItemToPath', item);
        },
        slicePath: function slicePath(state, index) {
            state.path = state.path.slice(0, index);
        }
    },
    getters: {
        selectedFiles: function selectedFiles(state) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return renameOption; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RenameOption; });
...
var RenameOption = function (_Option) {
    _inherits(RenameOption, _Option);

    function RenameOption(name) {
        var click = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (f) {};

        _classCallCheck(this, RenameOption);

        var _this = _possibleConstructorReturn(this, (RenameOption.__proto__ || Object.getPrototypeOf(RenameOption)).call(this, name, function (f) {
            _this.renaming = true;
            click(f);
        }, function (f) {
            return !f.blank;
...
var renameOption = new RenameOption('Rename');


/* harmony default export */ __webpack_exports__["b"] = (Option);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = generateBlankFile;
/* unused harmony export fileParser */
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function generateBlankFile(index) {
    var file = new File(Math.random(), null, index);
    file.blank = true;
    return file;
}
 ...
 */
var fileParser = function fileParser(list, idProp, nameProp) {
    fileList = [];
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('v-explorer', __WEBPACK_IMPORTED_MODULE_1__index__["a" /* Explorer */]);

new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    store: __WEBPACK_IMPORTED_MODULE_1__index__["e" /* store */],
    el: '#app',
    data: {
        files: [],
        options: []
    ...
    mounted: function mounted() {
        ...
        this.options.push(__WEBPACK_IMPORTED_MODULE_1__index__["d" /* renameOption */]);
        this.options.push(new __WEBPACK_IMPORTED_MODULE_1__index__["c" /* Option */]('teste', function (f) {
            _this.$store.commit('openFolder', f);
        }), function (f) {
            return f.dir;
        });
        this.files = [new __WEBPACK_IMPORTED_MODULE_1__index__["b" /* File */](1, "Folder 1", 10, 'folder')];
        this.files[0].dir = true;
        setTimeout(function () {
            this.files.push(new __WEBPACK_IMPORTED_MODULE_1__index__["b" /* File */](2, "Folder 2", 8, 'folder', 1, false, 0, true));
        }.bind(this), 3000);
    },
    ...
    methods: {
        ...
        fileRename: function fileRename(file) {
        ...
        drop: function drop(_ref) {
            ...
            var ids = this.files.map(function (f) {
                return f.id;
            });
            var fakeId = this.genFakeId();
            while (ids.find(function (id) {
                return id == fakeId;
            })) {
                fakeId = this.genFakeId();
            }
            var x = 0;
            var file = new __WEBPACK_IMPORTED_MODULE_1__index__["b" /* File */](fakeId, files[0].name, 4);
            file.uploading = true;
    ...
    computed: {
        currentFolder: function currentFolder() {
            return this.$store.getters.currentFolder != null ? this.$store.state.currentFolder : new __WEBPACK_IMPORTED_MODULE_1__index__["b" /* File */]('adc', 'C:');
        }
    }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_components_Explorer_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_components_Explorer_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__assets_components_Explorer_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_file__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_js_option__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_store_store__ = __webpack_require__(4);
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__assets_components_Explorer_vue___default.a; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__assets_js_file__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_2__assets_js_option__["b"]; });
/* unused harmony reexport RenameOption */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__assets_js_option__["c"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_3__assets_store_store__["a"]; });





/* unused harmony default export */ var _unused_webpack_default_export = (__WEBPACK_IMPORTED_MODULE_0__assets_components_Explorer_vue___default.a);
...
Component.options.__file = "assets/components/Explorer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d6b64e8c", Component.options)
  } else {
    hotAPI.reload("data-v-d6b64e8c", Component.options)
  }
...
// module
exports.push([module.i, "\n.v-exp-container > div[data-v-d6b64e8c] {\n  display: flex;\n  flex-wrap: wrap;\n  width: inherit;\n  height: inherit;\n}\n.v-exp-list-enter[data-v-d6b64e8c],\n.v-exp-list-leave-to[data-v-d6b64e8c] {\n  opacity: 0;\n  transform: translateY(30px);\n}\n.v-exp-list-leave-active[data-v-d6b64e8c] {\n  position: absolute;\n}\n", ""]);
    ...
    methods: {
        ...
        addListeners: function addListeners() {
            ...
            document.addEventListener("click", function () {
                _this3.$store.commit('clearSelectedFiles');
            });
        },
        ...
        deleteFile: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(file) {
                var containerWidth, block, blockStyle, blockWidth, numBlocksPerLine, mod, blank;
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                containerWidth = document.getElementById(this.id).offsetWidth;
                                block = document.getElementById(file.id);
                                blockStyle = getComputedStyle(block);
                                blockWidth = parseInt(blockStyle.marginLeft) + parseInt(blockStyle.marginRight) + block.clientWidth;
                                numBlocksPerLine = Math.floor(containerWidth / blockWidth);
                                mod = file.index % numBlocksPerLine;
                                blank = this.localFiles.find(function (f) {
    ...
    watch: {
        files: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4() {
                ...
                var _files, newFiles, parentId, _files2, deletedFiles;
                        ...
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 4:
                                ...
                                if (this.files.length > this.oldFiles.length) {
                                    ...
                                    newFiles = _files.filter(function (file) {
                                        return _this4.oldFiles.indexOf(file) === -1;
                                    });

                                    newFiles.forEach(function () {
                                        var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(file) {
                                            var blankFile;
                                            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
                                                while (1) {
                                                    switch (_context3.prev = _context3.next) {
                                                        case 0:
                                                            blankFile = _this4.localFiles.find(function (f) {
                                                                return Number(f.index) === Number(file.index);
                                                            });

                                                            _this4.localFiles.push(file);
                                                            file.blank = false;
                                                            file.index = _this4.localFiles.length - 1;
                                                            _this4.swap(file, blankFile);
                                    ...
                                    parentId = this.currentFolder == null ? null : this.currentFolder.id;
                                    _files2 = this.oldFiles.filter(function (f) {
                                        return f.parentId === parentId;
                                    });
                                    deletedFiles = _files2.filter(function (file) {
        ...
        path: function path(_path) {
            this.$store.commit('setCurrentFolder', _path[_path.length - 1].folder);
            this.loadLocalFiles();
        }
    },
    computed: {
...
Component.options.__file = "assets/components/File.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-205ab8f7", Component.options)
  } else {
    hotAPI.reload("data-v-205ab8f7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
__WEBPACK_IMPORTED_MODULE_3__fortawesome_fontawesome_svg_core__["c" /* library */].add(__WEBPACK_IMPORTED_MODULE_4__fortawesome_free_regular_svg_icons__["a" /* far */]);
...
Component.options.__file = "assets/components/ContextMenu.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c5e5703", Component.options)
  } else {
    hotAPI.reload("data-v-7c5e5703", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
        ...
        show: function show(val) {
            ...
            if (val) {
                ...
                this.$nextTick(function () {
                    ...
                    if (_this.$refs.opt && _this.autoResizeOptions) {
  ...
  return _c("transition", { attrs: { name: "v-exp-context-menu-fade" } }, [
    _vm.show
      ? _c(
          ...
          _vm._l(_vm.visible_options, function(opt) {
            return _c(
              "div",
              {
                key: opt.name,
...
var render = function() {
  ...
  return _c(
    ...
    [
      !_vm.file.blank
        ? _c("fa-icon", {
            staticClass: "v-file-icon",
            attrs: { icon: ["far", _vm.file.icon], size: "3x" }
          })
        : _vm._e(),
      _vm._v(" "),
      !_vm.file.blank && !_vm.renaming
        ? _c(
            "p",
            {
      ...
      _c("div", {
        ...
        class: { "v-exp-file-hover-enabled": _vm.draggingover }
      }),
      _vm._v(" "),
      _c("div", {
        staticClass: "v-exp-file-selected",
        class: { "v-exp-file-selected-enabled": _vm.selected }
      }),
      _vm._v(" "),
      _c("transition", { attrs: { name: "v-exp-fade" } }, [
        _vm.file.uploading
          ? _c(
              "div",
              {
      ...
      _c("v-context-menu", {
        attrs: {
          ...
          "auto-resize-options": _vm.autoResizeOptions
        },
        on: {
          "update:show": function($event) {
            _vm.showContextMenu = $event
          },
          "click-option": _vm.checkIfRename
        }
      })
    ],
    1
        ...
        _vm._l(_vm.localFiles, function(file) {
          return _c("v-file", {
            ...
            on: {
              ...
              "upload-canceled": _vm.uploadCanceled,
              "file-rename": _vm.fileRename,
              dblclick: _vm.dblclick
            }
          })
        })
